...
OBJECTS += TextLCD.o
 ...
 SYS_OBJECTS += mbed/TARGET_NUCLEO_F411RE/TOOLCHAIN_GCC_ARM/analogin_device.o
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1520579178.68
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1520579178.68
